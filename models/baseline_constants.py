...
MODEL_PARAMS = {
    ...
    'sent140.bag_log_reg': (2, ), # lr, num_classes
    'femnist.cnn': (62, ), # num_classes
    'shakespeare.stacked_lstm': (80, 80, 256), # seq_len, num_classes, num_hidden
    'celeba.cnn': (2, ), # num_classes
    'synthetic.log_reg': (5, 60), # num_classes, input_dim
    'reddit.stacked_lstm': (10, 256, 2), # seq_len, num_hidden, num_layers
}
